...
const NotificationRuleViewElement: FunctionComponent<ComponentProps> = (
  ...
  > = [
    ...
    },
    {
      ...
      description: `If your new channel name is "Encarta-${props.eventType?.toLowerCase()}-", then we will append the ${props.eventType} in the end so, it'll look like "Encarta-${props.eventType?.toLowerCase()}-X".`,
      fieldType: FieldType.Text,
